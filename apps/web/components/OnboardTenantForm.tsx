...
import { KENYA_COUNTIES, KENYA_COUNTY_CODE_TO_NAME } from '../lib/kenya-counties';
...
// Kenya counties list lives in lib/kenya-counties.ts now, shared with
// the public school-application form (apply/SchoolApplicationForm.tsx)
// so both forms draw from exactly one typed list rather than two
// copies that could drift out of sync.
const COUNTIES = KENYA_COUNTIES;
const COUNTY_CODE_TO_NAME = KENYA_COUNTY_CODE_TO_NAME;
